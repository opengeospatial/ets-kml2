 ...
 * kml:coordinates, kml:coord and kml:altitude elements. The allowed values are declared
 * by the schema component kml:AltitudeModeGroup; the default value is "clampToGround".
 */
public enum AltitudeMode {
	 ...
	 * @param value A String specifying an altitude mode.
	 * @return The AltitudeMode constant corresponding to the given value, or null if
	 * there is no match.
	 */
