...
/**
 * Checks CL2 constraints that apply to a style definition (kml:Style or kml:StyleMap)
 * element.
 *
...
public class StyleTests extends CommonFixture {
	...
	/**
	 * Finds kml:Style and kml:StyleMap elements in the KML document that do not appear in
	 * an update context. If none are found, all test methods defined in the class are
	 * skipped.
	 */
	@BeforeClass
	...
	/**
	 * [Test] Verifies that replacement text exists for all entity references appearing in
	 * a kml:BalloonStyle/kml:text element. The sources of the replacement text include
	 * the ancestor feature being styled and any kml:Schema elements that are associated
	 * with it.
	 *
